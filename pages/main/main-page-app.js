...
let popupClicks = document.querySelectorAll('.popup-click');
let body = document.querySelector('body');
let popup = document.querySelector('.popup');
let popupClose = document.querySelector('.popup-close');
let popupContent = document.querySelector('.popup-content');
let popupOverlay = document.querySelector('.overlay-popup');

let petArray = [];

for(let i = 0; i < popupClicks.length; i++){
  popupClicks[i].addEventListener('click', () => {
    getDescriptionPet(i);
    console.log(petArray)
    document.querySelector('.name').innerHTML = petArray.name;
    document.querySelector('.type').innerHTML = petArray.type;
    document.querySelector('.breed').innerHTML = petArray.breed;
    document.querySelector('.description').innerHTML = petArray.description;
    document.querySelector('.age').innerHTML = `<strong>Age:</strong> ${petArray.age}`;
    document.querySelector('.inoculations').innerHTML = `<strong>Inoculations:</strong> ${petArray.inoculations}`;
    document.querySelector('.diseases').innerHTML = `<strong>Diseases:</strong> ${petArray.diseases}`;
    document.querySelector('.parasites').innerHTML = `<strong>Parasites:</strong> ${petArray.parasites}`;
    if(window.screen.width < 767){
      document.querySelector('.img').classList.add('img-hide');
    }else{
      document.querySelector('.img').src = petArray.img;
    }
...
function getDescriptionPet(i) {
  let namePet =popupClicks[i].classList[1];
  for(i = 0; i < petsInfo.length; i++){
    let namePetArr = petsInfo[i].name;
    if(namePetArr === namePet){
      petArray = petsInfo[i];
      return petArray;
    }
  }
